...
def main():
	...
	water_layer_thickness = int(config.get('GROMACS_ANALYSIS', 'water_layer_thickness'))
...
#************************** STARTING FUNCTION *********************************
	def run_trajetory(md_obj):
		ana_dir = os.path.join(md_obj.path,"analysis")
		...
		nonwater_tpr = os.path.join(ana_dir,md_obj.get_prefix_ref()+"_non-water."+str(md_obj.get_repetion_number())+".tpr")
		nonwater_pdb = os.path.join(ana_dir,md_obj.get_prefix_ref()+"_non-water."+str(md_obj.get_repetion_number())+".pdb")
		waterlayer_pdb = os.path.join(ana_dir,md_obj.get_prefix_ref()+"_water-"+str(water_layer_thickness.value)+"A-layer."+str(md_obj.get_repetion_number())+".pdb")
		...
		t = 0
		frame = 0
		ndx_water_layer = os.path.join(ana_dir, md_obj.get_prefix_ref()+"water-layer"+str(md_obj.get_repetion_number())+".ndx")
		ndx_temporary = os.path.join(ana_dir, md_obj.get_prefix_ref()+"temporary"+str(md_obj.get_repetion_number())+".ndx")
