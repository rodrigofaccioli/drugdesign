...
def main():
	...
	path_to_save_normalized = os.path.join("selected_complexo", "normalized_buried_area_residue")
...
#************** END OF RESIDUE LIST
	...
	normalized_poseRDD = normalized_poseRDD.take(number_poses_to_select_buried_area)
